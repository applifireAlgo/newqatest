...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainDescription("LCLu6nYtxy9nh4tMziSOcumttGzHDUGhEJ0oNTHFgg7kyXx9iD");
        useraccessdomain.setDomainName("t13CCq4wEZdyv04HUVLkutUS8KRq3Dp9TZZHl6DGvjhZg0WPLY");
        useraccessdomain.setDomainHelp("OgYFdja2p4RNhxyHeq1sEsvxDIeAWvgU10NQN6vcOx04BsPnRs");
        useraccessdomain.setDomainIcon("EwRvUuWr9AQRrVfX9m0b8ykqxakOWH4DfwVGuRMp41GeqKRlI6");
        ...
        useraccesslevel.setLevelDescription("hHM1G4RcD3qk32LjG1h4PxQtkrB6D8XXDpEB4qzpBTgujAKL0e");
        useraccesslevel.setLevelIcon("r4QXX817B48hvWwLVME5AtHUv7BYzai1QjGat0yr1s78oIc3T3");
        useraccesslevel.setLevelHelp("2GMgruWOyzwaanBVa7ivDL2QeqWktExqvmhId34iPkItujXgIm");
        useraccesslevel.setLevelName("MGMLuJ8MkyjFzg9qVWWZofamnJAZYhuuEjzJQcMSS54Y6Vam95");
        ...
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465040630835l));
        user.setAllowMultipleLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465040630835l));
        user.setPasswordAlgo("LeT8dNxxzvP10bHHqcpt0pQOoFKaCfLpigVy3QAC23tjD9RE0S");
        user.setIsDeleted(1);
        user.setSessionTimeout(3351);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setUserAccessCode(20563);
        user.setChangePasswordNextLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("IN5IIVtwUs77ceYmF39LOG8BLsloB9LPjufH2SwKB2cWU3EgPz");
        Question question = new Question();
        question.setLevelid(1);
        question.setQuestionIcon("9Z2zNyQ1acUONmmCX8Z1nYYu4fVAXOwBY0ytcd2VoEdSnWloVS");
        question.setQuestionDetails("WsF67bMgSP");
        question.setQuestion("VBykg9ivthJAQz17Z0hhlkKwYg8iHEKgW1xgjsE9G2tbWEM8AJ");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("1zR5886V0ENdT6LYMBqnCxqofJmuyaBZpo26Tfily15VmrvSwd");
        passrecovery.setUser(user);
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePassword("lO6wj4ki3KkVhFqNifEJqAWUjBRt6vEf");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465040631322l));
        userdata.setOneTimePassword("afmXma0bDqhy5StlY2iHCo5vUVIGDiWz");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465040631350l));
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(10);
        userdata.setLast5Passwords("EYgKCITKavI8pNmL80FTHDNxkV9S1OUMOyFwVxrJi9jqjsx9bD");
        userdata.setPassword("uWZzNoFPppBNyQzOvnkAYJxANDiZ6vfUTlokXoLU2XlFjpRVXY");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 76513));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "Bf0m9PDYBAGH9cZtDaqu7UPwHFhh9XLNLCzg19MaRFnjIFTVHGGwK6zbGWQANkYgS"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 3976));
