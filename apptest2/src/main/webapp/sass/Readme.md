...
folder are mapped to the application's root namespace, 'Apptest2'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Apptest2' in the same way
as `"Apptest2/sass/src"`.
