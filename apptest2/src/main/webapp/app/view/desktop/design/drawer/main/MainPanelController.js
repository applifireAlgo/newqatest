Ext.define('Apptest2.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Apptest2.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Apptest2.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Apptest2.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Apptest2.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Apptest2.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Apptest2.view.clouddrive.CloudDrive");
    },
