Ext
		.define(
				'Apptest2.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Apptest2.view.searchengine.search.SearchEngineMainPanelController','Apptest2.view.searchengine.search.PanelHeaderField' ,'Apptest2.view.searchengine.search.ReportGridView','Apptest2.view.searchengine.search.ReportChartView','Apptest2.view.searchengine.search.documentView','Apptest2.view.searchengine.search.DouMeanView','Apptest2.view.googlemaps.map.MapPanel'],
