 ...
 * 
 */
Ext.define('Apptest2.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Apptest2.view.logalarm.mainscreen.AddLogAlarmController',
			'Apptest2.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Apptest2.view.logalarm.mainscreen.AppAlarmPanel',
