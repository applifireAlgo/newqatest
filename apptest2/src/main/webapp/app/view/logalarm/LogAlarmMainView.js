 ...
 * 
 */
Ext.define('Apptest2.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Apptest2.view.logalarm.LogAlarmMainViewController',
			'Apptest2.view.logalarm.tree.LogAlarmTreePanel',
			'Apptest2.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
