 ...
 * 
 */
Ext.define('Apptest2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Apptest2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
