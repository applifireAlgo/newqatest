...
Ext
		.define(
				'Apptest2.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Apptest2.view.logger.tabs.details.DetailsTab',
							'Apptest2.view.logger.tabs.fileconnector.FileConnectorTab',
							'Apptest2.view.logger.tabs.dbconnector.DBConnectorTab',
							'Apptest2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Apptest2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Apptest2.view.logger.LogConfigurationTabPanelController',
