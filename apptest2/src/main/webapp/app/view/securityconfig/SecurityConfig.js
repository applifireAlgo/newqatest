 ...
 * 
 */
Ext.define('Apptest2.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Apptest2.view.securityconfig.SecurityConfigController',
			'Apptest2.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
