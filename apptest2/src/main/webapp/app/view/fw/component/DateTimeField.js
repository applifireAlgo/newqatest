 ...
 */
Ext.define('Apptest2.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Apptest2.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Apptest2.view.fw.component.DateTimePicker(o);
    },
