Ext.define('Apptest2.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Apptest2.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Apptest2.view.console.ConsoleWindow');
