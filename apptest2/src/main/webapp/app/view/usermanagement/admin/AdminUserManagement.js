Ext.define('Apptest2.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Apptest2.view.usermanagement.admin.UserPasswordReset',
	            'Apptest2.view.usermanagement.admin.AddUserDetails',
	            'Apptest2.view.usermanagement.admin.ViewUser'],
