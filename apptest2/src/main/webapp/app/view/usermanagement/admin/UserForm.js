Ext.define('Apptest2.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Apptest2.view.usermanagement.admin.AddUserDetailsViewModel', 'Apptest2.model.AddUserDataModel' ],
